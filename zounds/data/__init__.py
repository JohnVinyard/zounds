...
data in the `hdf5 <http://en.wikipedia.org/wiki/Hierarchical_Data_Format>`_ and
uses the excellent `PyTables <http://www.pytables.org/moin>`_ library to access
it.  The :py:class:`~zounds.data.frame.pytables.PyTablesFrameController` tends
to be a bit faster than the 
